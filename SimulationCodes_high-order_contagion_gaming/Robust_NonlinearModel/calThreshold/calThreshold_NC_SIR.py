import sys
# sys.path.append('IPS_code_release/SimulationCodes_high-order_contagion_gaming/')
...
def main():
    ...
    muName = int(mu*10)
    with open(f'sir_ini1_result_all_mu{muName}.json', 'w') as f:
...
def run_one_simulation(args):
    ...
    simuSIR = SimuNonlinearContagion_SIR(HyperGraph)
    RNodesNum_allmc = []
    initialInfectedNodes = iniI 
